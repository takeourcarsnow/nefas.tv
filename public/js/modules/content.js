...
export const sectionContent = {
    ...
    'video-content': [
        { text: '> ffmpeg -i life.raw -c:v libx264 -crf 0 output.mp4', color: '#00ff9d', delay: 300 },
        { text: '[◉] Encoding reality at 60fps...', color: '#00ff9d', delay: 200 },
        { text: '[✓] Bitrate: yes', color: '#00ff00', delay: 200 },
        { text: '▄︻̷̿┻̿═━一 STREAMING CONSCIOUSNESS 一━═┻̷̿︻▄', color: '#ff00ff', delay: 100 },
        { text: '║                                        ║', color: '#ff00ff', delay: 50 },
        { text: '║  ▶ WARNING: May contain actual effort  ║', color: '#fff', delay: 50 },
        { text: '║  ⚡ Rendered on stolen electricity     ║', color: '#ffaa00', delay: 50 },
        { text: '║  ☢ Side effects include inspiration   ║', color: '#00ff00', delay: 50 },
        { text: '║                                        ║', color: '#ff00ff', delay: 50 },
        { text: '• • • • • • • • • • • • • 一━═┻̷̿︻▄', color: '#ff00ff', delay: 100 },
        { text: '', delay: 50 },
        { text: 'codec: whatever premiere didn\'t crash with', color: '#fff', delay: 50 },
        { text: 'audio: normalized to perfection (lie)', color: '#fff', delay: 50 }
    ],
    'photo-content': [
        ...
        { text: '', delay: 50 },
        { text: '╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲╱╲', color: '#ff00ff', delay: 50 },
        { text: '  Light theft documentation service', color: '#fff', delay: 50 },
        { text: '  Moments frozen, context optional', color: '#fff', delay: 50 },
